	...
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				</a> <a class="brand" href="#"> Back Office QCM Application </a>
				...
				<div class="nav-collapse">
					<ul class="nav pull-right">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<li onclick="window.location='${pageContext.request.contextPath}/backoffice/profil'"><a href="#"> <i class="icon-cog"></i>Profil</a></li>
								<li
					...
					<form class="navbar-search pull-right">
						<input type="text" class="search-query"
							placeholder="Chercher un E-mail" />
					</form>
		...
		<div class="subnavbar-inner">
			...
			<div class="container">
				...
				<ul class="mainnav">
					...
					<li><a href="${pageContext.request.contextPath}/backoffice/">
							<i class="icon-home"></i> <span>Acceuil</span>
					</a></li>

					<li><a
						href="${pageContext.request.contextPath}/backoffice/exams"> <i
							class="icon-edit"></i> <span> Mes QCM</span>
					</a></li>

					<li><a
						href="${pageContext.request.contextPath}/backoffice/resultats">
							<i class="icon-bar-chart"></i> <span>Voir Resultats </span>
					</a></li>

					<li><a
						href="${pageContext.request.contextPath}/backoffice/questions">
							<i class="icon-list-ol"></i> <span>Les Questions</span>
					</a></li>


					<li><a
						href="${pageContext.request.contextPath}/backoffice/accounts">
							<i class="icon-user"></i> <span>Gestion des comptes</span>
					</a></li>
